                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <a
                                        href="{{ route('transfer-request.index') }}"class="btn btn-light text-dark shadow rounded m-0">
                                        <span>Cancle</span></a>
                                </h3>
                            </div>
                            <form action="{{ route('transfer-request.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf()
                                {{-- @method('PATCH') --}}
