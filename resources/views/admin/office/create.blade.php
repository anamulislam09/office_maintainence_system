                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('office.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        {{-- <div class="form-group col-sm-12 col-md-6 col-lg-6">
                                            <label>Select Head Office</label>
                                            <select name="head_office_id" id="" class="form-control">
                                                <option value="" selected disabled>Select Once</option>
                                                @foreach ($office as $item)
                                                <option value="{{$item->head_office_id}}">{{$item->title}}</option>
                                                @endforeach
                                            </select>
                                        </div> --}}
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                                            <label>Select Zonal Office</label>
                                            <select name="zonal_office_id" id="" class="form-control">
                                                <option value="" selected disabled>Select Once</option>
                                                @foreach ($office as $item)
