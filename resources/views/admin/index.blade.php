                ...
                <div class="inner">
                  @php
                    if (
                        ...
                        $WorkingStatuses = ProductStatus::joinSub($subquery, 'product_latest', function ($join) {
                        ...
                        $productWorkingStatuses = ProductStatus::joinSub($subquery, 'product_latest', function ($join) {
                            $join->on('product_statuses.id', '=', 'product_latest.id');
                        })
                            ->where('status', 1)
                            ->count();
                ...
                <div class="inner">
                  @php
                     if (
                        ...
                        $NotWorking = ProductStatus::joinSub($subquery, 'product_latest', function ($join) {
                            $join->on('product_statuses.id', '=', 'product_latest.id');
                        })
                            ->where('status', 0)
                            ->where('office_id', Auth::guard('admin')->user()->office_id)
                        ...
                        $productNotWorking = ProductStatus::joinSub($subquery, 'product_latest', function ($join) {
                            $join->on('product_statuses.id', '=', 'product_latest.id');
                        })
                            ->where('status', 0)
                            ->count();
                ...
                <div class="inner">
                  @php
                    if (
                        ...
                        $dead = ProductStatus::joinSub($subquery, 'product_latest', function ($join) {
                            $join->on('product_statuses.id', '=', 'product_latest.id');
                        })
                            ->where('status', -1)
                            ->where('office_id', Auth::guard('admin')->user()->office_id)
                        ...
                        $totalDeadProduct = ProductStatus::joinSub($subquery, 'product_latest', function ($join) {
                            $join->on('product_statuses.id', '=', 'product_latest.id');
                        })
                            ->where('status', 0)
                            ->count();
