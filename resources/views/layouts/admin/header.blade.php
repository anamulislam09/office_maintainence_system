            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                        ...
                        <img class="img-profile rounded-circle" src="{{ Auth::guard('admin')->user()->image? asset('/uploads/admin/'. Auth::guard('admin')->user()->image): asset('frontend-assets/img/user.png') }}" height="30" width="30">
                    </a>
