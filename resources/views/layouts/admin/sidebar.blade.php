  ...
  <div class="sidebar">
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        {{-- @if (Auth::guard('admin')->user()->type == 'superadmin' || Auth::guard('admin')->user()->office_id == '1' || in_array('accessory', $privileges))
                    <li class="nav-item">
        ...
        @endif
        {{-- Product menu ends here --}}
        {{-- Assign menu start here --}}
        @if (Auth::guard('admin')->user()->type == 'superadmin' || in_array('Product-allocate', $privileges))
          <li
            ...
            <a href="#" class="nav-link {{ request()->is('admin/product-allocate/*') ? 'active' : '' }}">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Products Assign
                <i class="fas fa-angle-left right"></i>
        ...
        @endif
        {{-- Assign menu ends here --}}
        {{-- Status menu start here --}}
        @if (Auth::guard('admin')->user()->type == 'superadmin' ||
                Auth::guard('admin')->user()->office_id == '1' ||
          ...
          <li
            ...
            <a href="#" class="nav-link {{ request()->is('admin/product-status/*') ? 'active' : '' }}">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Products Status
                <i class="fas fa-angle-left right"></i>
          ...
          @endif
          {{-- Status menu ends here --}}
          {{-- Transfer menu start here --}}
        @if (Auth::guard('admin')->user()->type == 'superadmin' ||
          ...
          <li class="nav-item {{ request()->is('admin/transfer-request/*') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
              ...
              @endif
              @if (Auth::guard('admin')->user()->type == 'superadmin' || Auth::guard('admin')->user()->office_id == '1')
                <li class="nav-item">
        ...
        @if (in_array('Receive', $privileges))
          <li class="nav-item {{ request()->is('admin/receive-request/*') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
              {{-- @if (Auth::guard('admin')->user()->type == 'superadmin' || (Auth::guard('admin')->user()->office_id == '1' || in_array('Add', $privileges)))
                                <li class="nav-item">
                                    <a href="{{ url('admin/transfer-request/create') }}"
                                        class="nav-link {{ request()->is('admin/transfer-request/create') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
